...
MagicTower::MagicTower(cocos2d::Point _curPoint)
{
	...
	m_MagicTowerElectricSprite = cocos2d::Sprite::create("Magic_tower/19.png");
}

cocos2d::Sprite* MagicTower::getMagicTowerElectricSprite()
{
	auto effect = cocos2d::Sprite::create("Magic_tower/19.png");
	effect->setScale(0.5);
	return effect;
}
...
void MagicTower::createMagicTowerAction()
{
	...
	_magicTowerAction->setDelayPerUnit(0.1f);
...
{
	auto _magicTowerAction = cocos2d::Animation::create();
	_magicTowerAction->setDelayPerUnit(0.01f);

	_magicTowerAction->addSpriteFrame(cocos2d::Sprite::create("Magic_tower/19.png")->getSpriteFrame());
	_magicTowerAction->addSpriteFrame(cocos2d::Sprite::create("Magic_tower/20.png")->getSpriteFrame());

	return cocos2d::Animate::create(_magicTowerAction);
}
